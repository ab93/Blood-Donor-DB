...
<html class="no-js" lang="en" data-useragent="Mozilla/5.0 (compatible; MSIE 10.0; Windows NT 6.2; Trident/6.0)">
  ...
  <body>
    ...
    <nav class="top-bar" data-topbar>
        <ul class="title-area">
            <li class="name">
                <h1><a href="searchForBank.php">Blood Donor Central Database</a></h1>
            </li>
    ...
    <div class="row">  
        <form data-abide action="searchResultForBank.php" method="post">
            ...
            <div class="small-8">
                <div class="row">
                    ...
                    <div class="small-9 columns">
                        ...
                        <button type="submit" name="search_bank" style="position:relative; right: -600px; top:-20px">Search</button>
                    </div>
                </div>
            </div>
        </div> 
