    ...
    <!-- Left Nav Section -->
      ...
      <div class="row">
         <ul class="side-nav" style="position:relative; top:190px; right:200px ">
             <a href="Search.php" class="button [radius round]">Search</a></br>
             <a href="sendDonationReport.php" class="button [radius round]">Create Donation report</a></br>
             <a href="showHealthReport.php" class="button [radius round]">View Health report</a></br>   
         </ul>
     </div>
<?php
