    ...
    <!-- Left Nav Section -->
      ...
      <div class="row">
         <ul class="side-nav" style="position:relative; top:190px; right:200px ">
             <a href="#" class="button [radius round]">Search</a></br>
             <a href="#" class="button [radius round]">Create Donation report</a></br>
             <a href="#" class="button [radius round]">View Health report</a></br>   
         </ul>
     </div>

      <div class="row">  
        <form action="showHealthReport.php" method="post">
            ...
            <div class="small-8">
                <div class="row">
                    <div class="small-3 columns">
                        <label for="right-label" class="right inline" style="position:relative; right: -70px; top:50px">UserID</label>
                    </div>
                    <div class="small-9 columns">
                        <input type="text" style="position:relative; right: -70px; top:50px" name="user_id" id="right-label">
