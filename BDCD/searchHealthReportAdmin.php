...
<html class="no-js" lang="en" data-useragent="Mozilla/5.0 (compatible; MSIE 10.0; Windows NT 6.2; Trident/6.0)">
  ...
  <body>
    ...
    <!-- Left Nav Section -->
      ...
      <div class="row">  
        <form action="showHealthReportAdmin.php" method="post">
            ...
            <div class="small-8">
                <div class="row">
                    ...
                    <div class="small-9 columns">
                        ...
                        <button type="submit" name="search_health_report_admin" style="position:relative; right: -600px; top:-20px">Search</button>
                    </div>
                </div>
            </div>
        </div>
