...
<html class="no-js" lang="en" data-useragent="Mozilla/5.0 (compatible; MSIE 10.0; Windows NT 6.2; Trident/6.0)">
  ...
  <body>
    ...
    <nav class="top-bar" data-topbar>
        <ul class="title-area">
            <li class="name">
                <h1><a href="Search.php">Blood Donor Central Database</a></h1>
            </li>
        ...
        <form action="hospital.php" method="post">
            <ul class="right">
                <li class="active"><button type="submit" name="logout" >Logout</button></li>
            </ul>
        </form>
    ...
    <div class="row">  
        <form data-abide action="searchResult.php" method="post">
            ...
            <div class="small-8">
                <div class="row">
                    <div class="small-3 columns">
                        <label for="right-label" class="right inline" style="position:relative; right: -70px; top:50px"><b>Location</label>
                    </div>
                    <div class="small-9 columns">
                        <input type="text" style="position:relative; right: -70px; top:50px" name="location" id="right-label" required>
                        <button type="submit" name="search_hospital" style="position:relative; right: -600px; top:-20px">Search</button>
                    </div>
                </div>
            </div>
        </div> 
