...
<html class="no-js" lang="en" data-useragent="Mozilla/5.0 (compatible; MSIE 10.0; Windows NT 6.2; Trident/6.0)">
  ...
  <body>
    ...
    <div class="large-9 columns">
      ...
      <div class="row">
       <form data-abide action="user.php" method="post">
        <fieldset style="position:relative; top:30px;">
            <legend><h3 >Hospital Registration</h3></legend>
       <div class="row">
            <div class="small-8">   
                <div class="row">
        ...
        <div class="row">
            <div class="small-8">
                <div class="row">
                    ...
                    <input type="radio" name="type" value="Government" id="govt" required><label>Government</label>
                    <input type="radio" name="type" value="Private" id="private" required><label>Private</label>
                    </div>
